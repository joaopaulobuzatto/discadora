...
export class ClienteUpdateComponent implements OnInit {
  ...
  protected updateForm(cliente: ICliente): void {
    ...
    this.usersSharedCollection = this.userService.addUserToCollectionIfMissing(this.usersSharedCollection, cliente.consultor);
  ...
  protected loadRelationshipsOptions(): void {
    this.userService
      ...
      .pipe(map((users: IUser[]) => this.userService.addUserToCollectionIfMissing(users, this.editForm.get('consultor')!.value)))
