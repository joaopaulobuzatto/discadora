...
export class ResponsavelClienteService {
  ...
  protected convertDateFromClient(responsavelCliente: IResponsavelCliente): IResponsavelCliente {
    return Object.assign({}, responsavelCliente, {
      ...
      createdDate: responsavelCliente.createdDate?.isValid() ? responsavelCliente.createdDate.toJSON() : undefined,
      lastModifiedDate: responsavelCliente.lastModifiedDate?.isValid() ? responsavelCliente.lastModifiedDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((responsavelCliente: IResponsavelCliente) => {
        ...
        responsavelCliente.createdDate = responsavelCliente.createdDate ? dayjs(responsavelCliente.createdDate) : undefined;
        responsavelCliente.lastModifiedDate = responsavelCliente.lastModifiedDate ? dayjs(responsavelCliente.lastModifiedDate) : undefined;
      });
    }
    return res;
  }
