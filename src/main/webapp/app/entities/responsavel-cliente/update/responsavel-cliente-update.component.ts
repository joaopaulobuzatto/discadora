...
export class ResponsavelClienteUpdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.data.subscribe(({ responsavelCliente }) => {
      if (responsavelCliente.id === undefined) {
        ...
        responsavelCliente.createdDate = today;
        responsavelCliente.lastModifiedDate = today;
      }
  ...
  protected updateForm(responsavelCliente: IResponsavelCliente): void {
    this.editForm.patchValue({
      ...
      createdBy: responsavelCliente.createdBy,
      createdDate: responsavelCliente.createdDate ? responsavelCliente.createdDate.format(DATE_TIME_FORMAT) : null,
      lastModifiedBy: responsavelCliente.lastModifiedBy,
      lastModifiedDate: responsavelCliente.lastModifiedDate ? responsavelCliente.lastModifiedDate.format(DATE_TIME_FORMAT) : null,
