...
export class FaturaService {
  ...
  protected convertDateFromClient(fatura: IFatura): IFatura {
    return Object.assign({}, fatura, {
      ...
      createdDate: fatura.createdDate?.isValid() ? fatura.createdDate.toJSON() : undefined,
      lastModifiedDate: fatura.lastModifiedDate?.isValid() ? fatura.lastModifiedDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((fatura: IFatura) => {
        ...
        fatura.createdDate = fatura.createdDate ? dayjs(fatura.createdDate) : undefined;
        fatura.lastModifiedDate = fatura.lastModifiedDate ? dayjs(fatura.lastModifiedDate) : undefined;
      });
    }
    return res;
  }
