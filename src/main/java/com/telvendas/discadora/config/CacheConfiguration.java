package com.telvendas.discadora.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.telvendas.discadora.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.telvendas.discadora.repository.UserRepository.USERS_BY_EMAIL_CACHE);
