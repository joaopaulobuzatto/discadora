...
class ClienteResourceIT {
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getCreatedBy()).isEqualTo(DEFAULT_CREATED_BY);
        assertThat(testCliente.getCreatedDate()).isEqualTo(DEFAULT_CREATED_DATE);
        assertThat(testCliente.getLastModifiedBy()).isEqualTo(DEFAULT_LAST_MODIFIED_BY);
        assertThat(testCliente.getLastModifiedDate()).isEqualTo(DEFAULT_LAST_MODIFIED_DATE);
    }
    ...
    void putNewCliente() throws Exception {
        ...
        assertThat(testCliente.getCreatedBy()).isEqualTo(UPDATED_CREATED_BY);
        assertThat(testCliente.getCreatedDate()).isEqualTo(UPDATED_CREATED_DATE);
        assertThat(testCliente.getLastModifiedBy()).isEqualTo(UPDATED_LAST_MODIFIED_BY);
        assertThat(testCliente.getLastModifiedDate()).isEqualTo(UPDATED_LAST_MODIFIED_DATE);
    }
