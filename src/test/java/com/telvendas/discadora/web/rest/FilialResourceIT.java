...
class FilialResourceIT {
    ...
    public static Filial createEntity(EntityManager em) {
        Filial filial = new Filial().cnpj(DEFAULT_CNPJ).razaoSocial(DEFAULT_RAZAO_SOCIAL).nomeFantasia(DEFAULT_NOME_FANTASIA);
        return filial;
    }
    ...
    public static Filial createUpdatedEntity(EntityManager em) {
        Filial filial = new Filial().cnpj(UPDATED_CNPJ).razaoSocial(UPDATED_RAZAO_SOCIAL).nomeFantasia(UPDATED_NOME_FANTASIA);
        return filial;
    }
    ...
    void putNewFilial() throws Exception {
        ...
        updatedFilial.cnpj(UPDATED_CNPJ).razaoSocial(UPDATED_RAZAO_SOCIAL).nomeFantasia(UPDATED_NOME_FANTASIA);
    ...
    void partialUpdateFilialWithPatch() throws Exception {
        ...
        partialUpdatedFilial.cnpj(UPDATED_CNPJ).razaoSocial(UPDATED_RAZAO_SOCIAL);
    ...
    void fullUpdateFilialWithPatch() throws Exception {
        ...
        partialUpdatedFilial.cnpj(UPDATED_CNPJ).razaoSocial(UPDATED_RAZAO_SOCIAL).nomeFantasia(UPDATED_NOME_FANTASIA);
